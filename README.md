...
p.9.
型保存定理で、T-AppのΣの並びの定義を修正したのに伴い、E-App1の場合の証明を修正。また、E-App2の場合の証明の記述も追加。


## commit 2c417b9まで
p.5.
Σ1;Σ2 ⊢ t,M : T&ϕを∆;Σ1;Σ2 ⊢ t,M : T&ϕに変更。これに伴って、p.8.,p.9.の型保存定理の箇所も変更。

p.6.
型付け判断が dom(Σ1 ) ⊆ ∆ を満たすことを整合的であるといい、ここでは整合的な型付け判断だけ
を考えることにする。
の仮定を削除。代わりに、∆やdom(Σ)の要素が重複しないことを仮定。